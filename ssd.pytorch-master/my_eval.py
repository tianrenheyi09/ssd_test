...
'''
detpath =  'data/VOC2007\\results\\det_val_person.txt'
annopath = annopath
imagesetfile = imgsetpath.format(set_type)
classname='person'
cachedir = 'data/VOC2007\\annotations_cache'
ovthresh=0.5
use_07_metric=True
...
# plt.imshow(img1)
# cv2.rectangle(img1,(int(bb[0]),int(bb[1])),(int(bb[1]),int(bb[2])),(0,125,125),3)
...
################更改文件名
# import os
# file_list = os.listdir('data/Voc2007/results/')
# file_path = 'data/Voc2007/results/'
# for name in file_list:
#     tmp = name.split('_')
#     old_name = file_path+name
#     new_name = file_path+tmp[0]+'_val_'+tmp[2]
...
# load data
dataset = VOCDetection(voc_root, [('2007', 'val')],
